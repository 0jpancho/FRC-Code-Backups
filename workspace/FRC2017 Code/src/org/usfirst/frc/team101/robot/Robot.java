...
public class Robot extends IterativeRobot {
	...
	public void teleopPeriodic() {
		...
		{
			//Subtract 10% of the difference from left motor
		...
		//If current left motor speed is more than 0.1 below target...
		...
		//If current right motor speed is more than 0.1 above target
		...
		//If current right motor speed is more than 0.1 below target
